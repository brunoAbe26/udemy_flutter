...
mixin _$Product on _ProductBase, Store {
  ...
  final _$titleAtom = Atom(name: '_ProductBase.title');
  ...
  final _$priceAtom = Atom(name: '_ProductBase.price');
  ...
  final _$imageUrlAtom = Atom(name: '_ProductBase.imageUrl');
  ...
  final _$isFavoriteAtom = Atom(name: '_ProductBase.isFavorite');
  ...
  void toggleFavoriteStatus() {
    ...
    try {
      return super.toggleFavoriteStatus();
    } finally {
  ...
  String toString() {
    final string =
        'id: ${id.toString()},title: ${title.toString()},description: ${description.toString()},price: ${price.toString()},imageUrl: ${imageUrl.toString()},isFavorite: ${isFavorite.toString()}';
    return '{$string}';
  }
}
